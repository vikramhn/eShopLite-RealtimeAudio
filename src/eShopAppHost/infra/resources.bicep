...
resource sqlEshopapphostC8479139e4SqlDataFileShare 'Microsoft.Storage/storageAccounts/fileServices/shares@2022-05-01' = {
  parent: storageVolumeFileService
  name: take('${toLower('sql')}-${toLower('eshopapphostc8479139e4sqldata')}', 60)
  properties: {
    shareQuota: 1024
...
resource sqlEshopapphostC8479139e4SqlDataStore 'Microsoft.App/managedEnvironments/storages@2023-05-01' = {
  parent: containerAppEnvironment
  name: take('${toLower('sql')}-${toLower('eshopapphostc8479139e4sqldata')}', 32)
  properties: {
    azureFile: {
      shareName: sqlEshopapphostC8479139e4SqlDataFileShare.name
...
output SERVICE_SQL_VOLUME_ESHOPAPPHOSTC8479139E4SQLDATA_NAME string = sqlEshopapphostC8479139e4SqlDataStore.name
